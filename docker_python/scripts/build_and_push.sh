...
aws ecr-public describe-repositories --repository-names ${ecr_repo_name} --region $AWS_REGION || aws ecr-public create-repository --repository-name ${ecr_repo_name} --region $AWS_REGION
